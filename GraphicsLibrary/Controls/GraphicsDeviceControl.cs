...
namespace GraphicsLibrary.Controls
{
    ...
    public class GraphicsDeviceControl : HwndHost
    {
        ...
        /// </summary>
        public event EventHandler<GraphicsServiceEventArgs> LoadContent;
        ...
        /// <summary>
        /// Invoked when the XNA window is created
        /// </summary>
        ...
        protected override HandleRef BuildWindowCore(HandleRef hwndParent) {
            ...
            HandleRef r = new HandleRef(this, hWnd);
            if (WindowCreated != null) WindowCreated(this, new EventArgs());
            return r;
        }
